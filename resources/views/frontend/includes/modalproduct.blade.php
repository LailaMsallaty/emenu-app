    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header modal-header-lg dark bg-dark">
                ...
                <h4 class="modal-title">{{ __('Specify your dish') }}  </h4>
            ...
            <div class="modal-product-details">
                <div class="row align-items-center">
                    ...
                    <div class="col-3 text-lg text-right">{{ App::make('option')->getOPtionVal('currencysymbol') }}<span class="product-modal-price"></span></div>
                </div>
            </div>
            <div class="modal-body panel-details-container">
                <!-- Panel Details / Size -->
                <div class="panel-details panel-details-quantity">

                  <h5 class="panel-details-title"> {{ __('Quantity') }} </h5>
                ...
                <div class="panel-details panel-details-size">
                    <h5 class="panel-details-title">
                        ...
                        <a href="#panel-details-sizes-list" data-toggle="collapse">{{ __('Size') }} </a>
                    </h5>
                ...
                <div class="panel-details panel-details-additions">
                    <h5 class="panel-details-title">
                        ...
                        <a href="#panel-details-additions-content" data-toggle="collapse">{{ __('Additions')  }}</a>
                    </h5>
                ...
                <div class="panel-details panel-details-form">
                    <h5 class="panel-details-title">
                        ...
                        <a href="#panel-details-other" data-toggle="collapse">{{ __('Other') }} </a>
                    </h5>
                    <div id="panel-details-other" class="collapse">
                        <form action="#">
                            <textarea cols="30" rows="4" class="form-control" id="mynote" placeholder="{{ __('Write here your notes...') }}"></textarea>
                        </form>
                    </div>
                </div>
            </div>
            <button type="button" class="modal-btn btn btn-secondary btn-block btn-lg" data-action="add-to-cart"><span>{{ __('Add to cart') }}</span></button>
